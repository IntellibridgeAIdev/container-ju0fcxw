...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ju0fcxw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ju0fcxw.containers.anotherwebservice.com/
...
```
git clone git@github.com:IntellibridgeAIdev/container-ju0fcxw.git
cd container-ju0fcxw
```
...
```
docker attach container-ju0fcxw
```
